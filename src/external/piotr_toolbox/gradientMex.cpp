...
void gradMagNorm( float *M, float *S, int h, int w, float norm ) {
  ...
  // Modification by Jordi Pont-Tuset <jordi.pont@upc.edu> to avoid warning -Wunsequenced
  // From http://stackoverflow.com/questions/19578149/how-to-correct-this-unsequenced-modification
  ...
  int nb, int n, float norm, int nOrients, bool full, bool interpolate )
{
  ...
  // Modification by Jordi Pont-Tuset <jordi.pont@upc.edu> to avoid warning -Wunused-value
